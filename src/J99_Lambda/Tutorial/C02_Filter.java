...
public class C02_Filter {
    public static void main(String[] args) {
        ...
        System.out.println("\n   task04   ");
        printElCiftOtzbdrtBykFunctional( sayiList);
    ...
    public static void printElCiftOtzbsKckFunctional(List<Integer> sayiList) {
        sayiList
                ...
                //.filter( t->t<35 && t%2==0)
                .filter( t->t<35 ) // akısadaki elemanların 35 den kucuk olanlarını filtreler -> 16
    ...
    public static void printElCiftOtzbdrtBykFunctional(List<Integer> sayiList) {
               sayiList
               .stream()
                .filter( t->t>34 || t%2!=0)
