...
public class Task02 {
    public static void main(String[] args) {
        ...
        Map<Integer, Taska02_Kartvizit> krtvzt = new HashMap<>();//krvzt obj integer key ile depolayan bos map

        Taska02_Kartvizit k1 = new Taska02_Kartvizit("Abdi", "ebikGabık@gmail.com", "dut ağacının dibi", "12345");//krtvz obj
        Taska02_Kartvizit k2 = new Taska02_Kartvizit("Ali", "ali@gmail.com", "elma ağacının dibi", "9999");//krtvz obj
